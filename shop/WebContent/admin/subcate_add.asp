    ...
    <td align="center" valign="middle"> 
      ...
      <form name="form1" method="POST" action="<%=MM_editAction%>" onSubmit="return checkdata()">
        <table width="60%" border="0" cellspacing="2" cellpadding="2" bgcolor="#306898">
          <tr bgcolor="#FFFFFF"> 
            <td class="mid" width="19%" height="25" align="center">子类名称</td>
            <td width="81%" height="25"> 
              <input type="text" name="subcatename" size="30">
            </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td class="mid" width="19%" height="25" align="center">所属大类</td>
            <td width="81%" height="25"> 
              <select name="cateid">
                <%
While (NOT cateid.EOF)
%>
                <option value="<%=(cateid.Fields.Item("CategoryID").Value)%>" selected ><%=(cateid.Fields.Item("CategoryName").Value)%></option>
                <%
  cateid.MoveNext()
Wend
...
%>
          ...
          <tr bgcolor="#FFFFFF"> 
            <td class="mid" width="19%" align="center">描　　述</td>
            <td width="81%"> 
              <textarea name="subcatedes" cols="50" rows="3"></textarea>
            </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td class="mid" width="19%" height="25" align="center">图　　片</td>
            <td width="81%" height="25"> 
              <input type="text" name="subcateimg" size="30">
            </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td class="mid" width="19%" height="25" align="center">样　　式</td>
            <td width="81%" height="25"> 
              <input type="text" name="subcatecss" size="30">
            </td>
          </tr>
