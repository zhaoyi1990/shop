...
%>
<%
Dim adtodel__MMColParam
adtodel__MMColParam = "1"
if (Request.QueryString("AdID") <> "") then adtodel__MMColParam = Request.QueryString("AdID")
%>
<%
set adtodel = Server.CreateObject("ADODB.Recordset")
adtodel.ActiveConnection = MM_conneshop_STRING
adtodel.Source = "SELECT * FROM Advertise WHERE AdID = " + Replace(adtodel__MMColParam, "'", "''") + ""
adtodel.CursorType = 0
adtodel.CursorLocation = 2
adtodel.LockType = 3
adtodel.Open()
adtodel_numRows = 0
%>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td align="center" valign="middle"> 
      <p class="bigfont">您确认要删除这个广告吗？</p>
      <form name="form1" method="POST" action="<%=MM_editAction%>">
        <table width="80%" border="0" cellspacing="2" cellpadding="2" bgcolor="#7090B0">
          <tr> 
            <td width="12%" align="center"><b><font color="#FFFFFF">广告链接</font></b></td>
            <td width="88%" bgcolor="#FFFFFF"><%=(adtodel.Fields.Item("AdURL").Value)%></td>
          </tr>
          <tr> 
            <td width="12%" align="center"><b><font color="#FFFFFF">广告图片</font></b></td>
            <td width="88%" bgcolor="#FFFFFF"><img src="../adbanner/<%=(adtodel.Fields.Item("PicName").Value)%>" width="468" height="60"></td>
          </tr>
          <tr> 
            <td width="12%" align="center"><b><font color="#FFFFFF">广告说明</font></b></td>
            <td width="88%" bgcolor="#FFFFFF"><%=(adtodel.Fields.Item("AdNotes").Value)%></td>
          </tr>
        ...
        <input type="hidden" name="MM_recordId" value="<%= adtodel.Fields.Item("AdID").Value %>">
      </form>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
