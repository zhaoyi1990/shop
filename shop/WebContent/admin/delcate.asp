...
%>
<%
Dim catetodel__MMColParam
catetodel__MMColParam = "1"
if (Request.QueryString("CategoryID") <> "") then catetodel__MMColParam = Request.QueryString("CategoryID")
%>
<%
set catetodel = Server.CreateObject("ADODB.Recordset")
catetodel.ActiveConnection = MM_conneshop_STRING
catetodel.Source = "SELECT * FROM Categories WHERE CategoryID = " + Replace(catetodel__MMColParam, "'", "''") + ""
catetodel.CursorType = 0
catetodel.CursorLocation = 2
catetodel.LockType = 3
catetodel.Open()
catetodel_numRows = 0
%>
<html>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td align="center" valign="middle"> 
      <p class="bigfont">你确定要删除此大类吗？</p>
      <form name="form1" method="POST" action="<%=MM_editAction%>">
        <table width="80%" border="0" cellspacing="2" cellpadding="2" bgcolor="#306898">
          <tr bgcolor="#FFFFFF"> 
            <td width="26%" align="center" class="mid" height="30">大类名称</td>
            <td align="left" width="74%" class="mid" height="30"><%=(catetodel.Fields.Item("CategoryName").Value)%></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="26%" align="center" class="mid" height="30">描　　述</td>
            <td align="left" width="74%" class="mid" height="30"><%=(catetodel.Fields.Item("CategoryDes").Value)%></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="26%" align="center" class="mid" height="30">图　　片</td>
            <td align="left" width="74%" class="mid" height="30"><%=(catetodel.Fields.Item("CategoryImg").Value)%></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="26%" align="center" class="mid" height="30">样　　式</td>
            <td align="left" width="74%" class="mid" height="30"><%=(catetodel.Fields.Item("CategoryStyle").Value)%></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td colspan="2" align="center" class="mid" height="30"> 
              <input type="image" border="0" name="imageField" src="images/ok.gif" width="37" height="19">
              　　　　<a href="cate.asp"><img src="images/back.gif" width="37" height="19" border="0"></a></td>
          </tr>
        </table>
        <input type="hidden" name="MM_delete" value="true">
        <input type="hidden" name="MM_recordId" value="<%= catetodel.Fields.Item("CategoryID").Value %>">
      </form>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
