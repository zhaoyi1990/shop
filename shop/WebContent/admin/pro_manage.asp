...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr> 
    <td align="center" valign="middle"> 
      <p class="bigfont">请搜索你要管理的商品</p>
      <form name="form1" method="get" action="prolist.asp">
        <table width="60%" border="0" cellspacing="2" cellpadding="2" bgcolor="#3868A0">
          <tr bgcolor="#FFFFFF"> 
            <td width="29%" height="30" class="mid" align="center">搜索内容</td>
            <td width="71%" height="30" class="mid"> 
              <input type="text" name="scontent" class="fillbox">
            </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="29%" height="30" class="mid" align="center">搜索范围</td>
            <td width="71%" height="30" class="mid"> 
              <select name="srange" class="fillbox">
                <option value="ProductID" selected>商品编号</option>
                <option value="ProductName">商品名称</option>
                <option value="Supplier">发行单位</option>
              </select>
            </td>
          </tr>
          <tr bgcolor="#FFFFFF" align="center" valign="middle"> 
            <td colspan="2" height="30"> 
              <input type="submit" value="搜索" class="sbutton">
            </td>
          </tr>
        </table>
      </form>
      <p>&nbsp;</p>
      <p class="bigfont"><a href="pro_add.asp">按此新添商品</a></p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
    </td>
  </tr>
