  ...
  <table width="760" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#000000">
    ...
    <tr>
      <td bgcolor="#FFCC66" height="22"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>　<a href="index.jsp" class="red">首页</a> &gt; 销售排行</td>
            <td>&nbsp;</td>
          </tr>
        </table></td>
    </tr>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="30" valign="middle">　　<img src="images/bestsell.gif" width="190" height="30"></td>
  </tr>
  ...
  <tr>
    <td colspan="2">&nbsp;
      <table border="0" width="50%" align="center">
        <td width="23%" align="center"><c:if test="${pager.pageCount gt 0 }"> <a href="product_sell.do?currentPage=1" class="navi">第一页</a> </c:if></td>
          <td width="31%" align="center"><c:if test="${pager.hasPrev }"> <a href="product_sell.do?currentPage=${pager.currentPage-1}" class="navi">前一页</a> </c:if></td>
          <td width="23%" align="center"><c:if test="${pager.hasNext }"> <a href="product_sell.do?currentPage=${pager.currentPage+1}" class="navi">下一页</a> </c:if></td>
          <td width="23%" align="center"><c:if test="${pager.pageCount gt 0 }"> <a href="product_sell.do?currentPage=${pager.pageCount}" class="navi">最末页</a> </c:if></td>
      </table></td>
  </tr>
</table>
<br>
