  ...
  <table width="760" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#000000">
    ...
    <tr>
      <td bgcolor="#FFCC66" height="22"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>　<a href="index.jsp" class="red">首页</a> &gt; 特价商品</td>
            <td>&nbsp;</td>
          </tr>
        </table></td>
    </tr>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="30" valign="middle">　　<img src="images/bestprice.gif" width="190" height="30"></td>
  </tr>
    ...
    <td><table>
        <tr align="center" valign="top">
          <td><table width="380" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td rowspan="4" align="left" valign="top"><A HREF="product.jsp?id=${product.id}"><img src="images/product/${product.smallImg}" border="0"></A></td>
              ...
              <tr>
                <td width="255" valign="middle">原价：<span class="hotPrice">${product.price}</span>元 现价：${product.listPrice}</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
  ...
  <tr>
    <td colspan="2">&nbsp;
      <table border="0" width="50%" align="center">
        <td width="23%" align="center"><c:if test="${pager.pageCount gt 0 }"> <a href="product_price.do?currentPage=1" class="navi">第一页</a> </c:if></td>
          <td width="31%" align="center"><c:if test="${pager.hasPrev }"> <a href="product_price.do?currentPage=${pager.currentPage-1}" class="navi">前一页</a> </c:if></td>
          <td width="23%" align="center"><c:if test="${pager.hasNext }"> <a href="product_price.do?currentPage=${pager.currentPage+1}" class="navi">下一页</a> </c:if></td>
          <td width="23%" align="center"><c:if test="${pager.pageCount gt 0 }"> <a href="product_price.do?currentPage=${pager.pageCount}" class="navi">最末页</a> </c:if></td>
      </table></td>
  </tr>
</table>
<br>
